...
const greeterName = greeter("Jan!");
console.log(greeterName);
...
const mergeWord1 = merge("abra", "cadabra");
console.log(mergeWord1);
const mergeWord2 = merge("zoet", "sappig");
console.log(mergeWord2);
...
const dogInHumanYears = calculateDogYears(2);
console.log(dogInHumanYears);
...
const string = createDetailString ("Jan", "Jansen", "docent");
console.log(string);
